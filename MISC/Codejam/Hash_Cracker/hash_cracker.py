...
hashes_list = input("List of Hashes (hashes.txt): ")


def check_hash(password_list, hashes_list, option2):
...
def crack_hash(hash, hash_type, password_list, option2):
...
def start_hash_cracker():
    ...
    if option == "1":
        ...
        print("| 2. Print result in terminal    |")
        print("| 3. Return                      |")
        print("==================================")
        option2 = input("option >")
        if option2 == "1":
            check_hash(password_list=input("Password List: "), hashes_list=input("Hashes List: "), option2)
        elif option2 == "2":
            check_hash(password_list=input("Password List: "), hashes_list=input("Hashes List: "), option2)